...
Write-Host "Target: dreamexdatalab.com (Port 8080)" -ForegroundColor Cyan
...
Write-Host "  - https://dreamexdatalab.com/api/payments/initiate" -ForegroundColor White
Write-Host "  - https://dreamexdatalab.com/health" -ForegroundColor White
Write-Host ""
